// components/dashboard/EditDeviceModal.tsx
'use client';
...
import { 
  updateDevice, fetchBrands, fetchDeviceModels, fetchProcessors, 
...
const EditDeviceModal: React.FC<EditDeviceModalProps> = ({ 
  isOpen, onClose, onDeviceUpdated, device 
}) => {
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto">
          <div className="flex justify-between items-center p-6 border-b border-gray-200 dark:border-gray-700">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white">
              Edit Device - {device.serialNumber}
            </h2>
...
/>
            ...
            {updateDeviceMutation.isError && (
              <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded">
                {updateDeviceMutation.error.message}
              </div>
            )}
      ...
      {/* Add Item Modals - نفس الـ AddDeviceModal */}
      {showAddModal === 'brand' && (
        <AddItemModal
          isOpen={true}
